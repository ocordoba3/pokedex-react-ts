...
export function PokemonCard({ pokemon }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-end text-base md:text-lg font-normal text-slate-500 pt-1 md:pt-4 px-4">
        <span>#{pokemon.number.toString().padStart(3, "0")}</span>
      </div>
      <div className="relative md:mt-2 flex flex-col items-center">
